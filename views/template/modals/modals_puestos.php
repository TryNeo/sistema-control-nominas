<div class="modal fade" id="modalPuesto" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="modalTitle">Creacion de nuevo puesto <i class="fas fa-clipboard-list"></i></h5>
        </div>
        <div class="modal-body">
        <form id="formPuesto" name="formContracto">
            <div class="card-body row">
                    ...
                    <div class="col-md-10 mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="nombre_puesto" class="form-control" id="nombre_puesto"  placeholder="ingrese nombre del contracto">
                        </div>
                    </div>
                    <div class="col-md-10 mb-3">
                        <label class="control-label">Descripcion:</label>
                        <textarea name="descripcion" cols="30" rows="3" maxlength="250"  class="form-control"
                        placeholder="ingrese la descripcion" id="descripcion"></textarea>
                    </div>
            ...
            <div class="col-md-12 mb-3">
                ...
                <button type="button" class="btn btn-danger" onclick="return cerrar_modal('#modalPuesto')"><i class=" fas fa-exclamation-circle"></i> Cancelar</button>  
            </div>
        </form>
      </div>
    </div>
