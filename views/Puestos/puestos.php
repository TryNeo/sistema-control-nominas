...
<div class="dashboard-wrapper">
    <div class="container-fluid dashboard-content">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <button onclick="return abrir_modal();" class="btn btn-outline-secondary btnModal" data-target="#modalPuestos"><i class="fa fa-plus" aria-hidden="true"></i>
                Añadir nuevo puesto</button>     
            </div>
            <?php } ?>
        </div>
        <hr>
