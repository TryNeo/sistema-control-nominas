        ...
        public function getUsuarios(){
            ...
            for ($i=0; $i < count($data); $i++) { 
               ...
               <div class="text-center">
                <button  class="btn btn-primary btn-circle btnEditarUsuario" title="editar" rl="'.$data[$i]['id_usuario'].'"><i class="fa fa-edit"></i></button>
                <button  class="btn btn-danger btn-circle btnEliminarUsuario" title="eliminar" rl="'.$data[$i]['id_usuario'].'"><i class="far fa-thumbs-down"></i></button></div>';
            }
